---
banner: "assets/banners/Roon-Banner2.png"
banner_x: 0.2
banner_y: 0.55
---
...
This code displays all albums from the Roon folder sorted by artist. The dataview queries look like the following:
...
Where "A" is replaced by the appropriate uppercase letter. For artist names beginning with something other than A-Z, use:
